...
namespace Wraith
{
    ...
    {
        if (Begin(ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse))
        {
            ...
            if (ImGui::Button(m_Editor.GetGizmoSpace() == ImGuizmo::MODE::WORLD ? "World" : "Local"))
                m_Editor.SetGizmoSpace(m_Editor.GetGizmoSpace() == ImGuizmo::MODE::WORLD ? ImGuizmo::MODE::LOCAL : ImGuizmo::MODE::WORLD);
